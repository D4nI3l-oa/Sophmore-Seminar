...
app.post('/api/seed', async (req, res) => {
  try {
    ...
    const sampleProviders = [
      ...
      { provider_id: 'sg_002', name: 'WorldTrips', price: 171, website_link: 'https://www.worldtrips.com/#/start' },
      { provider_id: 'icp_003', name: 'Compas Student Insurance', price: 252, website_link: 'https://www.studenthealthusa.com/universitystudents.html' },
      { provider_id: 'chs_004', name: 'Campus Health Shield', price: 480, website_link: 'https://www.campushealth.com' },
      { provider_id: 'gsi_005', name: 'Patriot Exchange Standard', price: 312, website_link: 'https://www.imglobal.com/img-producer-insurance-plans/patriot-exchange-program?imgac=57479' },
      { provider_id: 'acn_006', name: 'Diplomat America', price: 395, website_link: 'https://www.academiccare.com' },
      ...
      { provider_id: 'uhi_009', name: 'Student Health Advantage', price: 493, website_link: 'https://www.imglobal.com/img-producer-insurance-plans/student-health-advantage?imgac=57479' },
      { provider_id: 'psi_010', name: 'Student Secure Elite', price: 523, website_link: 'https://www.worldtrips.com/international-student-insurance/elite#/ssq' },
      { provider_id: 'csi_011', name: 'Campus Shield Insurance', price: 365, website_link: 'https://www.campusshield.com' },
      { provider_id: 'isi_012', name: 'International Student Insurance', price: 420, website_link: 'https://www.internationalstudentinsurance.com' }
